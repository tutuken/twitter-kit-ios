Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://github.com/tutuken/twitter-kit-ios/releases/download/v3.4.3/TwitterCore.zip" }
  s.source = { :git => "https://github.com/tutuken/twitter-kit-ios.git", :branch => 'feature/fix_timestamp' }
